...
func (b binding) callback(e *Plugin) wago.CallerHostCallFunc {
	...
	return func(caller wago.Caller, call wago.HostCall) {
		...
		current := *e
		current.fs = state
		handler(&current, caller, call.ParamSlots(), call.ResultSlots())
	}
}
...
var importBindings = func() []binding {
	...
	return []binding{
		{"fd_write", (*Plugin).fdWrite, i32x4, i32, CapFDWrite, "write iovecs to a file descriptor (stdout/stderr)"},
		{"fd_read", (*Plugin).fdRead, i32x4, i32, CapFDRead, "read into iovecs from a file descriptor (stdin)"},
		{"fd_close", (*Plugin).fdClose, i32, i32, CapFDManage, "close a file descriptor (streams: no-op)"},
		{"fd_seek", (*Plugin).fdSeek, []wago.ValType{i32v, i64, i32v, i32v}, i32, CapFDManage, "seek a file descriptor (streams: ESPIPE)"},
		{"fd_fdstat_get", (*Plugin).fdFdstatGet, i32x2, i32, CapFDManage, "report fd stat (streams: character device)"},
		{"fd_prestat_get", (*Plugin).fdPrestatGet, i32x2, i32, CapFDManage, "report a preopen (none: EBADF)"},
		{"fd_prestat_dir_name", (*Plugin).fdPrestatDirName, i32x3, i32, CapFDManage, "report a preopen dir name (none: EBADF)"},
		{"proc_exit", (*Plugin).procExit, i32, nil, CapProcessExit, "terminate the program with an exit code"},
		{"args_sizes_get", (*Plugin).argsSizesGet, i32x2, i32, CapArgumentsRead, "report argc and argv byte size"},
		{"args_get", (*Plugin).argsGet, i32x2, i32, CapArgumentsRead, "write argv pointers and bytes"},
		{"environ_sizes_get", (*Plugin).environSizesGet, i32x2, i32, CapEnvironmentRead, "report environ count and byte size"},
		{"environ_get", (*Plugin).environGet, i32x2, i32, CapEnvironmentRead, "write environ pointers and bytes"},
		{"clock_time_get", (*Plugin).clockTimeGet, []wago.ValType{i32v, i64, i32v}, i32, CapClockRead, "read a clock's current time"},
		{"clock_res_get", (*Plugin).clockResGet, i32x2, i32, CapClockRead, "read a clock's resolution"},
		{"random_get", (*Plugin).randomGet, i32x2, i32, CapRandomRead, "fill a buffer with random bytes"},

		{"sched_yield", (*Plugin).schedYield, nil, i32, CapSchedulerYield, "yield execution"},
		{"fd_advise", (*Plugin).fdAdvise, []wago.ValType{i32v, i64, i64, i32v}, i32, CapFDManage, "provide file access advice"},
		{"fd_allocate", (*Plugin).fdAllocate, []wago.ValType{i32v, i64, i64}, i32, CapFDWrite, "allocate file space"},
		{"fd_datasync", (*Plugin).fdDatasync, i32, i32, CapFDWrite, "synchronize file data"},
		{"fd_sync", (*Plugin).fdSync, i32, i32, CapFDWrite, "synchronize a file"},
		{"fd_fdstat_set_flags", (*Plugin).fdFdstatSetFlags, i32x2, i32, CapFDManage, "set descriptor flags"},
		{"fd_fdstat_set_rights", (*Plugin).fdFdstatSetRights, []wago.ValType{i32v, i64, i64}, i32, CapFDManage, "reduce descriptor rights"},
		{"fd_filestat_get", (*Plugin).fdFilestatGet, i32x2, i32, CapFDRead, "get file metadata"},
		{"fd_filestat_set_size", (*Plugin).fdFilestatSetSize, []wago.ValType{i32v, i64}, i32, CapFDWrite, "set file size"},
		{"fd_filestat_set_times", (*Plugin).fdFilestatSetTimes, []wago.ValType{i32v, i64, i64, i32v}, i32, CapFDWrite, "set file timestamps"},
		{"fd_pread", (*Plugin).fdPread, []wago.ValType{i32v, i32v, i32v, i64, i32v}, i32, CapFDRead, "read at an offset"},
		{"fd_pwrite", (*Plugin).fdPwrite, []wago.ValType{i32v, i32v, i32v, i64, i32v}, i32, CapFDWrite, "write at an offset"},
		{"fd_readdir", (*Plugin).fdReaddir, []wago.ValType{i32v, i32v, i32v, i64, i32v}, i32, CapFDRead, "read directory entries"},
		{"fd_renumber", (*Plugin).fdRenumber, i32x2, i32, CapFDManage, "renumber a descriptor"},
		{"fd_tell", (*Plugin).fdTell, i32x2, i32, CapFDManage, "get a descriptor offset"},
		{"path_create_directory", (*Plugin).pathCreateDirectory, i32x3, i32, CapPathWrite, "create a directory"},
		{"path_filestat_get", (*Plugin).pathFilestatGet, []wago.ValType{i32v, i32v, i32v, i32v, i32v}, i32, CapPathRead, "get path metadata"},
		{"path_filestat_set_times", (*Plugin).pathFilestatSetTimes, []wago.ValType{i32v, i32v, i32v, i32v, i64, i64, i32v}, i32, CapPathWrite, "set path timestamps"},
		{"path_link", (*Plugin).pathLink, []wago.ValType{i32v, i32v, i32v, i32v, i32v, i32v, i32v}, i32, CapPathWrite, "create a hard link"},
		{"path_open", (*Plugin).pathOpen, []wago.ValType{i32v, i32v, i32v, i32v, i32v, i64, i64, i32v, i32v}, i32, CapPathOpen, "open a path with rights limited by its preopen"},
		{"path_readlink", (*Plugin).pathReadlink, []wago.ValType{i32v, i32v, i32v, i32v, i32v, i32v}, i32, CapPathRead, "read a symbolic link"},
		{"path_remove_directory", (*Plugin).pathRemoveDirectory, i32x3, i32, CapPathWrite, "remove a directory"},
		{"path_rename", (*Plugin).pathRename, []wago.ValType{i32v, i32v, i32v, i32v, i32v, i32v}, i32, CapPathWrite, "rename a path"},
		{"path_symlink", (*Plugin).pathSymlink, []wago.ValType{i32v, i32v, i32v, i32v, i32v}, i32, CapPathWrite, "create a symbolic link"},
		{"path_unlink_file", (*Plugin).pathUnlinkFile, i32x3, i32, CapPathWrite, "unlink a file"},
		{"poll_oneoff", (*Plugin).pollOneoff, i32x4, i32, CapPoll, "wait for events"},
		{"proc_raise", (*Plugin).procRaise, i32, i32, CapUnsupported, "raise a signal (unsupported)"},
		{"sock_accept", (*Plugin).sockAccept, i32x3, i32, CapUnsupported, "accept a socket (unsupported)"},
		{"sock_recv", (*Plugin).sockRecv, []wago.ValType{i32v, i32v, i32v, i32v, i32v, i32v}, i32, CapUnsupported, "receive from a socket (unsupported)"},
		{"sock_send", (*Plugin).sockSend, []wago.ValType{i32v, i32v, i32v, i32v, i32v}, i32, CapUnsupported, "send to a socket (unsupported)"},
		{"sock_shutdown", (*Plugin).sockShutdown, i32x2, i32, CapUnsupported, "shut down a socket (unsupported)"},
	}
}()
