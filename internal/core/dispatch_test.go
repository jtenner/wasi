...
func TestHostDispatchMatchesReference(t *testing.T) {
	reference := map[string]func(*Plugin, wago.HostModule, []uint64, []uint64){
		...
		"args_sizes_get":          func(e *Plugin, m wago.HostModule, p, r []uint64) { e.argsSizesGet(m.Memory(), p, r) },
		"args_get":                func(e *Plugin, m wago.HostModule, p, r []uint64) { e.argsGet(m.Memory(), p, r) },
		"environ_sizes_get":       func(e *Plugin, m wago.HostModule, p, r []uint64) { e.environSizesGet(m.Memory(), p, r) },
		"environ_get":             func(e *Plugin, m wago.HostModule, p, r []uint64) { e.environGet(m.Memory(), p, r) },
